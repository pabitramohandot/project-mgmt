    ...
    <div className="animate-fade-in" style={{ maxWidth: "900px" }}>
      <div className="page-header" style={{ marginBottom: "2rem" }}>
        <div>
          ...
          <p className="page-subtitle">
            Configure custom primary and secondary accents and upload corporate
            logos for your tenant dashboard.
          </p>
        </div>
      </div>
      ...
      {isReadOnly && (
        ...
        >
          <Lock size={16} />
          <span>
            You have read-only access. Only Company Administrators can modify
            brand styles.
          </span>
        </div>
      )}
          ...
          <form onSubmit={handleFormSubmit}>
            ...
            {!isReadOnly && (
              ...
              >
                <Save size={18} />
                <span>
                  {submitting ? "Saving changes..." : "Save Branding Config"}
                </span>
              </button>
            )}
          </form>
